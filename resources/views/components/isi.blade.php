<div class="mx-auto max-w-7xl bg-white px-4 py-8 sm:px-6 lg:px-8" x-data>
  <div class="grid grid-cols-2 gap-x-4 gap-y-8 sm:gap-x-6 md:grid-cols-3 lg:grid-cols-4 xl:gap-x-8">
    <article
    <a
      x-cloak
      x-show="($store.shop.activeCategory === 'semua' || $store.shop.activeCategory === 'makanan') && 'sei sapi sambal luat makanan'.includes($store.shop.searchQuery.toLowerCase())"
      href="#"
    ...
    <a
      x-cloak
      x-show="($store.shop.activeCategory === 'semua' || $store.shop.activeCategory === 'makanan') && 'kolo nasi bakar bambu makanan'.includes($store.shop.searchQuery.toLowerCase())"
      href="#"
      class="group relative overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:ring-gray-300"
    >
      <div class="aspect-square w-full overflow-hidden bg-gray-200">
    ...
    <a
      x-cloak
      x-show="($store.shop.activeCategory === 'semua' || $store.shop.activeCategory === 'makanan') && 'catemak jagung manis makanan'.includes($store.shop.searchQuery.toLowerCase())"
      href="#"
      class="group relative overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:ring-gray-300"
    >
      <div class="aspect-square w-full overflow-hidden bg-gray-200">
    ...
    <a
      x-cloak
      x-show="($store.shop.activeCategory === 'semua' || $store.shop.activeCategory === 'minuman') && 'kopi bajawa flores minuman'.includes($store.shop.searchQuery.toLowerCase())"
      href="#"
      class="group relative overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:ring-gray-300"
    >
      <div class="aspect-square w-full overflow-hidden bg-gray-200">
