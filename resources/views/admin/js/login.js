/**
 * login.js - Admin UMKM Culinary's NTT
 * Berisi helper data global (AdminDB, render sidebar) + logika khusus halaman login.html.
 */
...
/* ===== Logika khusus halaman login.html (dipindahkan dari <script> inline) ===== */
const form = document.getElementById('admin-login-form');
    ...
    form.addEventListener('submit', (e) => {
      ...
      if (AdminDB.login(email, pass)) {
        window.location.href = 'dashboard.html';
      } else {
        errBox.style.display = 'block';
        errBox.innerText = 'Email atau password salah! Gunakan demo admin@warung.com / password123';
      }
    });
