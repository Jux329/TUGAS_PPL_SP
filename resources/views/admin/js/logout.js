/**
 * logout.js - Admin UMKM Culinary's NTT
 * Berisi helper data global (AdminDB, render sidebar) + logika khusus halaman logout.html.
 */
...
/* ===== Logika khusus halaman logout.html (dipindahkan dari <script> inline) ===== */
AdminDB.logout();
